...
////////////////////////////////////////////////////////////////////////////////////// PUNTO 6
app.get('/precio_producto/:id', async (req, res) => {
    try {
        let productoId = parseInt(req.params.id)
        let productoEncontrado = await Producto.findByPk(productoId)
...
////////////////////////////////////////////////////////////////////////////////////// PUNTO 7
app.get('/nombre_producto/:id', async (req, res) => {
    try {
        let productoId = parseInt(req.params.id)
        let productoEncontrado = await Producto.findByPk(productoId)
...
////////////////////////////////////////////////////////////////////////////////////// PUNTO 8
app.get('/telefono_usuario/:id', async (req, res) => {
    try {
        let usuarioId = parseInt(req.params.id)
        let usuarioEncontrado = await Usuario.findByPk(usuarioId)

       if (usuarioEncontrado) {
            res.status(200).json({"telefono": usuarioEncontrado.nombre})
        } else {
...
////////////////////////////////////////////////////////////////////////////////////// PUNTO 9
app.get('/nombre_usuario/:id', async (req, res) => {
    try {
        let usuarioId = parseInt(req.params.id)
        let usuarioEncontrado = await Usuario.findByPk(usuarioId)
...
////////////////////////////////////////////////////////////////////////////////////// PUNTO 10
app.get('/total_stock/', async (req, res) => {
    try {
        let allProducts = await Producto.findAll()
        
        let total = allProducts.reduce((acc, producto) => acc + producto.precio, 0)
